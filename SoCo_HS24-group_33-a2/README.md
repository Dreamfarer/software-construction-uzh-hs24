...
<a id="reporting.aggregate_function_stats"></a>

#### aggregate\_function\_stats
...
- `data` _dict_ - A dictionary with function calls data parsed from the log file by 'parse_log'.
