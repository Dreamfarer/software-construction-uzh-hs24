...
<a id="reporting.generate_function_stats"></a>

#### generate\_function\_stats

```python
def generate_function_stats(data: dict) -> dict
```

Aggregates function call statistics from parsed log data.

**Arguments**:

- `data` _dict_ - A dictionary with individual function call data parsed from the log file generated by 'parse_log'
...
- `data` _dict_ - A dictionary with aggregated function statistics generated by 'generate_function_stats'.
